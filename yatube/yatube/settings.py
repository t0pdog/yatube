...
SECRET_KEY = '%p=e!4e*u16jv*fw)#zqgm2#$&&ik^6b6wv6ff3^6r@y+v(q1e'
...
INSTALLED_APPS = [
    ...
    'django.contrib.auth',  # Прил. для регистр. и авториз. польз.
    'django.contrib.contenttypes',
    'django.contrib.sessions',
    'django.contrib.messages',
    'django.contrib.staticfiles', # необходимо для работы приложения DjDT
...
MIDDLEWARE = [
    ...
    'debug_toolbar.middleware.DebugToolbarMiddleware', # Добавленная запись
]
...
# Переопределим адреса страниц, на которые пользователь будет перенаправлен
...
# Загружаемые файлы хранятся в директории
MEDIA_URL = '/media/'
